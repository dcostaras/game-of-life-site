...
goog.addDependency("../devcards/system.js", ['devcards.system'], ['devcards.util.utils', 'cljs.core', 'goog.history.EventType', 'goog.object', 'cljsjs.react', 'goog.History', 'cljs.core.async', 'sablono.core', 'cljsjs.react.dom', 'devcards.util.edn_renderer', 'goog.labs.userAgent.device', 'clojure.string', 'goog.events']);
...
goog.addDependency("../devcards/core.js", ['devcards.core'], ['devcards.util.utils', 'devcards.system', 'cljs.core', 'cljs.test', 'goog.object', 'cljs.core.async', 'sablono.core', 'devcards.util.edn_renderer', 'devcards.util.markdown', 'clojure.string']);
goog.addDependency("../clojure/math/combinatorics.js", ['clojure.math.combinatorics'], ['cljs.core']);
goog.addDependency("../game_of_life/core.js", ['game_of_life.core'], ['cljs.core', 'clojure.math.combinatorics', 'clojure.set']);
goog.addDependency("../game_of_life/core_test.js", ['game_of_life.core_test'], ['game_of_life.patterns', 'devcards.core', 'cljs.core', 'cljs.test', 'game_of_life.core']);
goog.addDependency("../runners/tests.js", ['runners.tests'], ['cljs.core', 'game_of_life.core_test']);
...
goog.addDependency("../game_of_life/renderer.js", ['game_of_life.renderer'], ['game_of_life.patterns', 'cljs.core', 'game_of_life.core', 'clojure.set', 'quil.core', 'quil.middleware']);
...
goog.addDependency("../figwheel/connect/build_devcards_test.js", ['figwheel.connect.build_devcards_test'], ['devcards.core', 'cljs.core', 'figwheel.client', 'figwheel.client.utils', 'runners.browser']);
