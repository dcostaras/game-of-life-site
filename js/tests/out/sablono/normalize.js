...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.call(null,(function (p__38859){
var vec__38860 = p__38859;
var _ = cljs.core.nth.call(null,vec__38860,(0),null);
var v = cljs.core.nth.call(null,vec__38860,(1),null);
...
if(((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$))) && (cljs.core.every_QMARK_.call(null,(function (p1__38863_SHARP_){
return ((p1__38863_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__38863_SHARP_ === 'string');
}),class$))){
...
return cljs.core.update_in.call(null,G__38864,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__38864;
}
});
...
var len__31507__auto___38867 = arguments.length;
var i__31508__auto___38868 = (0);
while(true){
if((i__31508__auto___38868 < len__31507__auto___38867)){
args__31514__auto__.push((arguments[i__31508__auto___38868]));

var G__38869 = (i__31508__auto___38868 + (1));
i__31508__auto___38868 = G__38869;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__31515__auto__);
});
...
var G__38866 = cljs.core.reduce.call(null,cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes))){
return cljs.core.assoc.call(null,G__38866,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec.call(null,classes));
} else {
return G__38866;
}
} else {
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq38865){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq38865));
});
...
var vec__38872 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__38872,(0),null);
var names = cljs.core.nth.call(null,vec__38872,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css.call(null,cljs.core.some.call(null,((function (matches,vec__38872,tag_name,names){
return (function (p1__38870_SHARP_){
if(cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__38870_SHARP_))){
return p1__38870_SHARP_;
} else {
return null;
}
});})(matches,vec__38872,tag_name,names))
,names)),cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.comp.call(null,cljs.core.filter.call(null,((function (matches,vec__38872,tag_name,names){
return (function (p1__38871_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__38871_SHARP_));
});})(matches,vec__38872,tag_name,names))
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__38875){
var vec__38876 = p__38875;
var seq__38877 = cljs.core.seq.call(null,vec__38876);
var first__38878 = cljs.core.first.call(null,seq__38877);
var seq__38877__$1 = cljs.core.next.call(null,seq__38877);
var tag = first__38878;
var content = seq__38877__$1;
...
var vec__38879 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__38879,(0),null);
...
//# sourceMappingURL=normalize.js.map?rel=1512749389397
