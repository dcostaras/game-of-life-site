...
var x__30961__auto__ = (((x == null))?null:x);
var m__30962__auto__ = (sablono.util.to_str[goog.typeOf(x__30961__auto__)]);
if(!((m__30962__auto__ == null))){
return m__30962__auto__.call(null,x);
} else {
var m__30962__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__30962__auto____$1 == null))){
return m__30962__auto____$1.call(null,x);
} else {
...
var x__30961__auto__ = (((x == null))?null:x);
var m__30962__auto__ = (sablono.util.to_uri[goog.typeOf(x__30961__auto__)]);
if(!((m__30962__auto__ == null))){
return m__30962__auto__.call(null,x);
} else {
var m__30962__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__30962__auto____$1 == null))){
return m__30962__auto____$1.call(null,x);
} else {
...
var len__31507__auto___38846 = arguments.length;
var i__31508__auto___38847 = (0);
while(true){
if((i__31508__auto___38847 < len__31507__auto___38846)){
args__31514__auto__.push((arguments[i__31508__auto___38847]));

var G__38848 = (i__31508__auto___38847 + (1));
i__31508__auto___38847 = G__38848;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__31515__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq38845){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq38845));
});
...
var vec__38849 = cljs.core.name.call(null,k).split("-");
...
var first_word = first__38851;
var words = seq__38850__$1;
...
var m__$1 = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__38852){
var vec__38853 = p__38852;
var k = cljs.core.nth.call(null,vec__38853,(0),null);
var v = cljs.core.nth.call(null,vec__38853,(1),null);
...
return cljs.core.update.call(null,G__38856,new cljs.core.Keyword(null,"style","style",-496642736),sablono.util.camel_case_keys);
} else {
return G__38856;
}
} else {
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__30228__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1512749389287
