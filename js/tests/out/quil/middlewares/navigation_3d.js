...
var vec__44365 = axis;
var a_x = cljs.core.nth.call(null,vec__44365,(0),null);
var a_y = cljs.core.nth.call(null,vec__44365,(1),null);
var a_z = cljs.core.nth.call(null,vec__44365,(2),null);
var vec__44368 = v;
var x = cljs.core.nth.call(null,vec__44368,(0),null);
var y = cljs.core.nth.call(null,vec__44368,(1),null);
var z = cljs.core.nth.call(null,vec__44368,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__44371,p__44372){
var vec__44373 = p__44371;
var u1 = cljs.core.nth.call(null,vec__44373,(0),null);
var u2 = cljs.core.nth.call(null,vec__44373,(1),null);
var u3 = cljs.core.nth.call(null,vec__44373,(2),null);
var vec__44376 = p__44372;
var v1 = cljs.core.nth.call(null,vec__44376,(0),null);
var v2 = cljs.core.nth.call(null,vec__44376,(1),null);
var v3 = cljs.core.nth.call(null,vec__44376,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__44379_SHARP_){
return (p1__44379_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__44380_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__44381_SHARP_,angle_lr),angle_ud);
...
var map__44383 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__44383__$1 = ((((!((map__44383 == null)))?((((map__44383.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__44383.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__44383):map__44383);
var up = cljs.core.get.call(null,map__44383__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__44383__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5455__auto__ = (function (){var pred__44385 = cljs.core._EQ_;
var expr__44386 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__44385.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__44386))){
return straight;
} else {
if(cljs.core.truth_(pred__44385.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__44386))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__44385.call(null,quil.middlewares.navigation_3d.space,expr__44386))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__44385.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__44386))){
return up;
} else {
if(cljs.core.truth_(pred__44385.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__44386))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__44385.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__44386))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__5455__auto__,map__44383,map__44383__$1,up,straight){
return (function (p1__44382_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__44382_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__5455__auto__,map__44383,map__44383__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__44388_SHARP_);
});})(initial_state))
);
});
/**
...
var map__44389_44400 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__44389_44401__$1 = ((((!((map__44389_44400 == null)))?((((map__44389_44400.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__44389_44400.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__44389_44400):map__44389_44400);
var vec__44390_44402 = cljs.core.get.call(null,map__44389_44401__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_44403 = cljs.core.nth.call(null,vec__44390_44402,(0),null);
var c_y_44404 = cljs.core.nth.call(null,vec__44390_44402,(1),null);
var c_z_44405 = cljs.core.nth.call(null,vec__44390_44402,(2),null);
var vec__44393_44406 = cljs.core.get.call(null,map__44389_44401__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_44407 = cljs.core.nth.call(null,vec__44393_44406,(0),null);
var u_y_44408 = cljs.core.nth.call(null,vec__44393_44406,(1),null);
var u_z_44409 = cljs.core.nth.call(null,vec__44393_44406,(2),null);
var vec__44396_44410 = cljs.core.get.call(null,map__44389_44401__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_44411 = cljs.core.nth.call(null,vec__44396_44410,(0),null);
var p_y_44412 = cljs.core.nth.call(null,vec__44396_44410,(1),null);
var p_z_44413 = cljs.core.nth.call(null,vec__44396_44410,(2),null);
quil.core.camera.call(null,p_x_44411,p_y_44412,p_z_44413,(p_x_44411 + c_x_44403),(p_y_44412 + c_y_44404),(p_z_44413 + c_z_44405),u_x_44407,u_y_44408,u_z_44409);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1512749402832
