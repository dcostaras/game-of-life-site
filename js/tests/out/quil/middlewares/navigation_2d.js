...
return cljs.core.merge.call(null,initial_state,p1__44913_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_44914 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_44915 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_44914);
var pos_44916 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_44914);
quil.core.scale.call(null,zoom_44915);

var tr__44820__auto___44917 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_44915) - cljs.core.first.call(null,pos_44916)),(((quil.core.height.call(null) / (2)) / zoom_44915) - cljs.core.second.call(null,pos_44916))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__44820__auto___44917);
...
//# sourceMappingURL=navigation_2d.js.map?rel=1512749404075
