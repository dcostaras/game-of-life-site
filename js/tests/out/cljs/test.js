...
var G__35123 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__35123,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__35123;
}
});
...
var or__30228__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__31507__auto___35128 = arguments.length;
var i__31508__auto___35129 = (0);
while(true){
if((i__31508__auto___35129 < len__31507__auto___35128)){
args__31514__auto__.push((arguments[i__31508__auto___35129]));

var G__35130 = (i__31508__auto___35129 + (1));
i__31508__auto___35129 = G__35130;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__31515__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq35125){
var G__35126 = cljs.core.first.call(null,seq35125);
var seq35125__$1 = cljs.core.next.call(null,seq35125);
var G__35127 = cljs.core.first.call(null,seq35125__$1);
var seq35125__$2 = cljs.core.next.call(null,seq35125__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__35126,G__35127,seq35125__$2);
});
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__35132,map__35132__$1,file,line,column){
return (function (p1__35131_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__35131_SHARP_));
});})(map__35132,map__35132__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__31283__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__31283__auto__,prefer_table__31284__auto__,method_cache__31285__auto__,cached_hierarchy__31286__auto__,hierarchy__31287__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__30228__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__30228__auto__)){
return or__30228__auto__;
} else {
...
var temp__5457__auto___35134 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___35134)){
var message_35135 = temp__5457__auto___35134;
cljs.core.println.call(null,message_35135);
} else {
}
...
var temp__5457__auto___35136 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___35136)){
var message_35137 = temp__5457__auto___35136;
cljs.core.println.call(null,message_35137);
} else {
}
...
var output_dir = "resources/public/js/tests/out";
var output_dir__$1 = (function (){var G__35138 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35138),"/"].join('');
} else {
return G__35138;
}
})();
...
var temp__5455__auto__ = (function (){var and__30216__auto__ = typeof exception.stack === 'string';
if(and__30216__auto__){
var G__35140 = exception.stack;
var G__35140__$1 = (((G__35140 == null))?null:clojure.string.split_lines.call(null,G__35140));
var G__35140__$2 = (((G__35140__$1 == null))?null:cljs.core.get.call(null,G__35140__$1,depth));
if((G__35140__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__35140__$2);
}
} else {
...
var vec__35141 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__35141,(0),null);
var column = cljs.core.nth.call(null,vec__35141,(1),null);
var vec__35144 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__35144,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__35144,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__35144,(2),null);
...
var m__$1 = (function (){var G__35147 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__35151 = (function (){var G__35150 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__35150);
} else {
return G__35150;
}
})();
...
return cljs.core.vary_meta.call(null,G__35152,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__35156 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__35156,(0),null);
var types = vec__35156;
...
return cljs.core.map.call(null,(function (p__35159){
var vec__35160 = p__35159;
var ns = cljs.core.nth.call(null,vec__35160,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__35160,(1),null);
return ((function (vec__35160,ns,vars__$1){
return (function (){
...
var G__35163 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__35163,G__35163__$1,env,once_fixtures,each_fixtures,vec__35160,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__35163,G__35163__$1,env,once_fixtures,each_fixtures,vec__35160,ns,vars__$1){
return (function (){
var seq__35164 = cljs.core.seq.call(null,vars__$1);
var chunk__35165 = null;
var count__35166 = (0);
var i__35167 = (0);
while(true){
if((i__35167 < count__35166)){
var v = cljs.core._nth.call(null,chunk__35165,i__35167);
var temp__5457__auto___35169 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___35169)){
var t_35170 = temp__5457__auto___35169;
each_fixture_fn.call(null,((function (seq__35164,chunk__35165,count__35166,i__35167,t_35170,temp__5457__auto___35169,v,each_fixture_fn,G__35163,G__35163__$1,env,once_fixtures,each_fixtures,vec__35160,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_35170)));
});})(seq__35164,chunk__35165,count__35166,i__35167,t_35170,temp__5457__auto___35169,v,each_fixture_fn,G__35163,G__35163__$1,env,once_fixtures,each_fixtures,vec__35160,ns,vars__$1))
);
} else {
}

var G__35171 = seq__35164;
var G__35172 = chunk__35165;
var G__35173 = count__35166;
var G__35174 = (i__35167 + (1));
seq__35164 = G__35171;
chunk__35165 = G__35172;
count__35166 = G__35173;
i__35167 = G__35174;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__35164);
if(temp__5457__auto__){
var seq__35164__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__35164__$1)){
var c__31159__auto__ = cljs.core.chunk_first.call(null,seq__35164__$1);
var G__35175 = cljs.core.chunk_rest.call(null,seq__35164__$1);
var G__35176 = c__31159__auto__;
var G__35177 = cljs.core.count.call(null,c__31159__auto__);
var G__35178 = (0);
seq__35164 = G__35175;
chunk__35165 = G__35176;
count__35166 = G__35177;
i__35167 = G__35178;
continue;
} else {
var v = cljs.core.first.call(null,seq__35164__$1);
var temp__5457__auto___35179__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___35179__$1)){
var t_35180 = temp__5457__auto___35179__$1;
each_fixture_fn.call(null,((function (seq__35164,chunk__35165,count__35166,i__35167,t_35180,temp__5457__auto___35179__$1,v,seq__35164__$1,temp__5457__auto__,each_fixture_fn,G__35163,G__35163__$1,env,once_fixtures,each_fixtures,vec__35160,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_35180)));
});})(seq__35164,chunk__35165,count__35166,i__35167,t_35180,temp__5457__auto___35179__$1,v,seq__35164__$1,temp__5457__auto__,each_fixture_fn,G__35163,G__35163__$1,env,once_fixtures,each_fixtures,vec__35160,ns,vars__$1))
);
} else {
}

var G__35181 = cljs.core.next.call(null,seq__35164__$1);
var G__35182 = null;
var G__35183 = (0);
var G__35184 = (0);
seq__35164 = G__35181;
chunk__35165 = G__35182;
count__35166 = G__35183;
i__35167 = G__35184;
continue;
}
} else {
...
});})(each_fixture_fn,G__35163,G__35163__$1,env,once_fixtures,each_fixtures,vec__35160,ns,vars__$1))
);
});})(each_fixture_fn,G__35163,G__35163__$1,env,once_fixtures,each_fixtures,vec__35160,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35163__$1)].join('')));

}
})());
});
;})(vec__35160,ns,vars__$1))
...
//# sourceMappingURL=test.js.map?rel=1512749382506
