...
return (new CustomEvent(event_name,(function (){var obj41683 = {"detail":data};
return obj41683;
})()));
} else {
...
var f = (function (){var pred__41690 = cljs.core._EQ_;
var expr__41691 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__41690.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__41691))){
return ((function (pred__41690,expr__41691){
return (function (p1__41684_SHARP_){
return console.warn(p1__41684_SHARP_);
});
;})(pred__41690,expr__41691))
} else {
if(cljs.core.truth_(pred__41690.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__41691))){
return ((function (pred__41690,expr__41691){
return (function (p1__41685_SHARP_){
return console.debug(p1__41685_SHARP_);
});
;})(pred__41690,expr__41691))
} else {
if(cljs.core.truth_(pred__41690.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__41691))){
return ((function (pred__41690,expr__41691){
return (function (p1__41686_SHARP_){
return console.error(p1__41686_SHARP_);
});
;})(pred__41690,expr__41691))
} else {
return ((function (pred__41690,expr__41691){
return (function (p1__41687_SHARP_){
return console.log(p1__41687_SHARP_);
});
;})(pred__41690,expr__41691))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__41694){
...
var eval_fn = cljs.core.get.call(null,map__41695__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__41697_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__41699,(0),null);
...
}catch (e41704){if((e41704 instanceof Error)){
var e = e41704;
return not_found;
} else {
throw e41704;
...
//# sourceMappingURL=utils.js.map?rel=1512749394116
