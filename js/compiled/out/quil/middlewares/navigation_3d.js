...
var vec__51816 = axis;
var a_x = cljs.core.nth.call(null,vec__51816,(0),null);
var a_y = cljs.core.nth.call(null,vec__51816,(1),null);
var a_z = cljs.core.nth.call(null,vec__51816,(2),null);
var vec__51819 = v;
var x = cljs.core.nth.call(null,vec__51819,(0),null);
var y = cljs.core.nth.call(null,vec__51819,(1),null);
var z = cljs.core.nth.call(null,vec__51819,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__51822,p__51823){
var vec__51824 = p__51822;
var u1 = cljs.core.nth.call(null,vec__51824,(0),null);
var u2 = cljs.core.nth.call(null,vec__51824,(1),null);
var u3 = cljs.core.nth.call(null,vec__51824,(2),null);
var vec__51827 = p__51823;
var v1 = cljs.core.nth.call(null,vec__51827,(0),null);
var v2 = cljs.core.nth.call(null,vec__51827,(1),null);
var v3 = cljs.core.nth.call(null,vec__51827,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__51830_SHARP_){
return (p1__51830_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__51831_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__51832_SHARP_,angle_lr),angle_ud);
...
var map__51834 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__51834__$1 = ((((!((map__51834 == null)))?((((map__51834.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__51834.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__51834):map__51834);
var up = cljs.core.get.call(null,map__51834__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__51834__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5455__auto__ = (function (){var pred__51836 = cljs.core._EQ_;
var expr__51837 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__51836.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__51837))){
return straight;
} else {
if(cljs.core.truth_(pred__51836.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__51837))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__51836.call(null,quil.middlewares.navigation_3d.space,expr__51837))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__51836.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__51837))){
return up;
} else {
if(cljs.core.truth_(pred__51836.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__51837))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__51836.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__51837))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__5455__auto__,map__51834,map__51834__$1,up,straight){
return (function (p1__51833_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__51833_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__5455__auto__,map__51834,map__51834__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__51839_SHARP_);
});})(initial_state))
);
});
/**
...
var map__51840_51851 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__51840_51852__$1 = ((((!((map__51840_51851 == null)))?((((map__51840_51851.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__51840_51851.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__51840_51851):map__51840_51851);
var vec__51841_51853 = cljs.core.get.call(null,map__51840_51852__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_51854 = cljs.core.nth.call(null,vec__51841_51853,(0),null);
var c_y_51855 = cljs.core.nth.call(null,vec__51841_51853,(1),null);
var c_z_51856 = cljs.core.nth.call(null,vec__51841_51853,(2),null);
var vec__51844_51857 = cljs.core.get.call(null,map__51840_51852__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_51858 = cljs.core.nth.call(null,vec__51844_51857,(0),null);
var u_y_51859 = cljs.core.nth.call(null,vec__51844_51857,(1),null);
var u_z_51860 = cljs.core.nth.call(null,vec__51844_51857,(2),null);
var vec__51847_51861 = cljs.core.get.call(null,map__51840_51852__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_51862 = cljs.core.nth.call(null,vec__51847_51861,(0),null);
var p_y_51863 = cljs.core.nth.call(null,vec__51847_51861,(1),null);
var p_z_51864 = cljs.core.nth.call(null,vec__51847_51861,(2),null);
quil.core.camera.call(null,p_x_51862,p_y_51863,p_z_51864,(p_x_51862 + c_x_51854),(p_y_51863 + c_y_51855),(p_z_51864 + c_z_51856),u_x_51858,u_y_51859,u_z_51860);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1512749429289
