...
return cljs.core.merge.call(null,initial_state,p1__51883_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_51884 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_51885 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_51884);
var pos_51886 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_51884);
quil.core.scale.call(null,zoom_51885);

var tr__44820__auto___51887 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_51885) - cljs.core.first.call(null,pos_51886)),(((quil.core.height.call(null) / (2)) / zoom_51885) - cljs.core.second.call(null,pos_51886))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__44820__auto___51887);
...
//# sourceMappingURL=navigation_2d.js.map?rel=1512749429394
