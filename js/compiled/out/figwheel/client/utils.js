...
var or__30228__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj50425 = {"detail":data};
return obj50425;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__30216__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__30216__auto__)){
var and__30216__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__50432 = cljs.core._EQ_;
var expr__50433 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__50432.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__50433))){
return ((function (pred__50432,expr__50433){
return (function (p1__50426_SHARP_){
return console.warn(p1__50426_SHARP_);
});
;})(pred__50432,expr__50433))
} else {
if(cljs.core.truth_(pred__50432.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__50433))){
return ((function (pred__50432,expr__50433){
return (function (p1__50427_SHARP_){
return console.debug(p1__50427_SHARP_);
});
;})(pred__50432,expr__50433))
} else {
if(cljs.core.truth_(pred__50432.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__50433))){
return ((function (pred__50432,expr__50433){
return (function (p1__50428_SHARP_){
return console.error(p1__50428_SHARP_);
});
;})(pred__50432,expr__50433))
} else {
return ((function (pred__50432,expr__50433){
return (function (p1__50429_SHARP_){
return console.log(p1__50429_SHARP_);
});
;})(pred__50432,expr__50433))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__50436){
...
var eval_fn = cljs.core.get.call(null,map__50437__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__50439_SHARP_){
return new_def.callback(p1__50439_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__50441,(0),null);
var v = cljs.core.nth.call(null,vec__50441,(1),null);
...
if(cljs.core.truth_((function (){var and__30216__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1512749424256
