...
var o53555 = temp__5455__auto__;
var temp__5455__auto____$1 = (o53555["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o53556 = temp__5455__auto____$1;
return (o53556["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__52636__auto__ = f;
return (o__52636__auto__["toString"]).call(o__52636__auto__);
} else {
return "";
}
}catch (e53557){var _ = e53557;
return "";
}});
...
try{var o__52636__auto___53559 = t;
(o__52636__auto___53559["cljs$lang$ctorPrWriter"]).call(o__52636__auto___53559,t,writer);
}catch (e53558){var __53560 = e53558;
}
...
var char_code = (function (){var o__52636__auto__ = (new String(char$));
return (o__52636__auto__["charCodeAt"]).call(o__52636__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__52636__auto__ = String;
return (o__52636__auto__["fromCharCode"]).call(o__52636__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__53561 = num_code;
switch (G__53561) {
case (1):
return (185);
...
var o__52636__auto__ = String;
return (o__52636__auto__["fromCharCode"]).call(o__52636__auto__,superscript_code);
});
/**
...
}catch (e53563){var _e__52643__auto__ = e53563;
return false;
}})())){
...
var vec__53564 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__53564,(0),null);
...
var or__30228__auto__ = (function (){var temp__5455__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5455__auto__)){
...
if(cljs.core.truth_(temp__5455__auto__)){
var o53567 = temp__5455__auto__;
var temp__5455__auto____$1 = (o53567["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o53568 = temp__5455__auto____$1;
return (o53568["nameToPath"]);
} else {
return null;
}
} else {
...
var len__31507__auto___53575 = arguments.length;
var i__31508__auto___53576 = (0);
while(true){
if((i__31508__auto___53576 < len__31507__auto___53575)){
args__31514__auto__.push((arguments[i__31508__auto___53576]));

var G__53577 = (i__31508__auto___53576 + (1));
i__31508__auto___53576 = G__53577;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31515__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__53571){
var vec__53572 = p__53571;
var ns_detector = cljs.core.nth.call(null,vec__53572,(0),null);
var effective_detector = (function (){var or__30228__auto__ = ns_detector;
if(cljs.core.truth_(or__30228__auto__)){
return or__30228__auto__;
} else {
...
var G__53578 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__53579 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__53578;
remaining_tokens = G__53579;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq53569){
var G__53570 = cljs.core.first.call(null,seq53569);
var seq53569__$1 = cljs.core.next.call(null,seq53569);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__53570,seq53569__$1);
});
...
var vec__53583 = cljs.core.split_with.call(null,(function (p1__53582_SHARP_){
return cljs.core.not_EQ_.call(null,p1__53582_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__53583,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__53583,(1),null);
...
var vec__53586 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__53586,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__53586,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__53589 = cljs.core.rest.call(null,remaining_tokens);
var G__53590 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__53589;
name_tokens = G__53590;
continue;
} else {
...
var vec__53593 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__53593,(0),null);
var arity = cljs.core.nth.call(null,vec__53593,(1),null);
var vec__53596 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__53596,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__53596,(1),null);
var vec__53599 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__53599,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__53599,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__53599,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__53599,(3),null);
...
var vec__53605 = result;
var munged_ns = cljs.core.nth.call(null,vec__53605,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__53605,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__53605,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__53605,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__53605,(4),null);
var arity = cljs.core.nth.call(null,vec__53605,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__53609 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__53609,(0),null);
var args = cljs.core.nth.call(null,vec__53609,(1),null);
var vec__53612 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__53612,(0),null);
var name = cljs.core.nth.call(null,vec__53612,(1),null);
...
var G__53615 = (arity + (1));
var G__53616 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__53617){
var vec__53618 = p__53617;
var arity = cljs.core.nth.call(null,vec__53618,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__53618,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__30228__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__30228__auto__)){
return or__30228__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__53621_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__53622_SHARP_){
return cljs.core.drop.call(null,(2),p1__53622_SHARP_);
...
var args__31514__auto__ = [];
var len__31507__auto___53629 = arguments.length;
var i__31508__auto___53630 = (0);
while(true){
if((i__31508__auto___53630 < len__31507__auto___53629)){
args__31514__auto__.push((arguments[i__31508__auto___53630]));

var G__53631 = (i__31508__auto___53630 + (1));
i__31508__auto___53630 = G__53631;
continue;
} else {
}
break;
...
var argseq__31515__auto__ = ((((1) < args__31514__auto__.length))?(new cljs.core.IndexedSeq(args__31514__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31515__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__53625){
var vec__53626 = p__53625;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__53626,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq53623){
var G__53624 = cljs.core.first.call(null,seq53623);
var seq53623__$1 = cljs.core.next.call(null,seq53623);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__53624,seq53623__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__30228__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__30228__auto__)){
return or__30228__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__30216__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__30228__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__30228__auto__)){
return or__30228__auto__;
} else {
...
var map__53634 = options;
var map__53634__$1 = ((((!((map__53634 == null)))?((((map__53634.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53634.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__53634):map__53634);
var include_ns_QMARK_ = cljs.core.get.call(null,map__53634__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__53634__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__53634__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__53634__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__53635 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__53635,(0),null);
var fn_name = cljs.core.nth.call(null,vec__53635,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__53635,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__53635,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__53635,(4),null);
var arity = cljs.core.nth.call(null,vec__53635,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__30216__auto__ = protocol_ns;
if(cljs.core.truth_(and__30216__auto__)){
return cljs.core.not.call(null,(function (){var and__30216__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__30228__auto__ = protocol_part;
if(cljs.core.truth_(or__30228__auto__)){
return or__30228__auto__;
} else {
return fn_part;
...
var o__52636__auto__ = f;
return (o__52636__auto__["getBasis"]).call(o__52636__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__30216__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__30216__auto__)){
...
}catch (e53639){var _e__52643__auto__ = e53639;
...
var G__53640 = (obj[cljs.core.first.call(null,path)]);
var G__53641 = cljs.core.rest.call(null,path);
obj = G__53640;
path = G__53641;
continue;
} else {
...
var partition_bits = (function (){var or__30228__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__30228__auto__)){
return or__30228__auto__;
} else {
return (0);
...
return (function (accum,p__53642){
var vec__53643 = p__53642;
var bit = cljs.core.nth.call(null,vec__53643,(0),null);
var protocol = cljs.core.nth.call(null,vec__53643,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__53646){
var vec__53647 = p__53646;
var ns = cljs.core.nth.call(null,vec__53647,(0),null);
var name = cljs.core.nth.call(null,vec__53647,(1),null);
var selector = cljs.core.nth.call(null,vec__53647,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__53652,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__53652,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__53652,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__53650_SHARP_){
return (obj[cljs.core.first.call(null,p1__53650_SHARP_)]);
});})(name,sorted_matches,vec__53652,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1512749432910
