...
var len__31507__auto___53677 = arguments.length;
var i__31508__auto___53678 = (0);
while(true){
if((i__31508__auto___53678 < len__31507__auto___53677)){
args__31514__auto__.push((arguments[i__31508__auto___53678]));

var G__53679 = (i__31508__auto___53678 + (1));
i__31508__auto___53678 = G__53679;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31515__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq53675){
var G__53676 = cljs.core.first.call(null,seq53675);
var seq53675__$1 = cljs.core.next.call(null,seq53675);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__53676,seq53675__$1);
});
...
return (function (p1__53680_SHARP_){
return (p1__53680_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1512749433271
