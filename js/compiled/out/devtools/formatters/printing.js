...
var len__31507__auto___53686 = arguments.length;
var i__31508__auto___53687 = (0);
while(true){
if((i__31508__auto___53687 < len__31507__auto___53686)){
args__31514__auto__.push((arguments[i__31508__auto___53687]));

var G__53688 = (i__31508__auto___53687 + (1));
i__31508__auto___53687 = G__53688;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__31515__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq53683){
var G__53684 = cljs.core.first.call(null,seq53683);
var seq53683__$1 = cljs.core.next.call(null,seq53683);
var G__53685 = cljs.core.first.call(null,seq53683__$1);
var seq53683__$2 = cljs.core.next.call(null,seq53683__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__53684,G__53685,seq53683__$2);
});
...
if(cljs.core.truth_((function (){var or__30228__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__30899__auto__,writer__30900__auto__,opt__30901__auto__){
return cljs.core._write.call(null,writer__30900__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__30216__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__30216__auto__){
var or__30228__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__30228__auto__)){
return or__30228__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__53689_SHARP_){
return !((cljs.core.meta.call(null,p1__53689_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__53690__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__30228__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e53694){var _e__52643__auto__ = e53694;
return false;
}})();
if(cljs.core.truth_(or__30228__auto__)){
return or__30228__auto__;
...
}catch (e53696){var _e__52643__auto__ = e53696;
return false;
}}
})())){
...
var _STAR_current_state_STAR_53698 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__53699 = opts;
var map__53699__$1 = ((((!((map__53699 == null)))?((((map__53699.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53699.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__53699):map__53699);
var markup_db = cljs.core.get.call(null,map__53699__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_53698;
}});
...
;
var temp__5455__auto___53703 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___53703)){
var managed_print_level_53704 = temp__5455__auto___53703;
var _STAR_print_level_STAR_53702_53705 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_53704;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_53702_53705,managed_print_level_53704,temp__5455__auto___53703,writer,opts,job_fn){
return (function (p1__53701_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__53701_SHARP_,null);
});})(_STAR_print_level_STAR_53702_53705,managed_print_level_53704,temp__5455__auto___53703,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_53702_53705;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1512749433429
